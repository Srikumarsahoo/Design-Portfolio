...
export default function Hero() {
  ...
  return (
    ...
    >
      {/* Award badge */}
      <div
        className="animate-item anim-hidden max-w-6xl mx-auto px-6 flex items-center gap-2 mb-6"
      ...
      <div className="max-w-6xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-8 items-end">
        <div className="relative z-10 pb-16">
          ...
          {/* Headline */}
          <div
            className="animate-item anim-hidden"
          ...
          {/* CTA Button */}
          <div
            className="animate-item anim-hidden flex items-center gap-4"
          ...
          {/* Stats */}
          <div
            className="animate-item anim-hidden flex items-center gap-3 mt-10"
        ...
        {/* Hero Image */}
        <div
          className="animate-item anim-hidden relative flex justify-center lg:justify-end"
